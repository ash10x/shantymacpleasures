...
export default function ShopClient({ products, categories }: Props) {
  ...
  return (
    <div className="relative max-w-7xl mx-auto px-6 py-36 overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-semibold bg-linear-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent">
          ...
          <motion.button
            ...
            className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${
              selectedCategory === cat
                ? "bg-linear-to-r from-pink-500 to-purple-600 text-white shadow-lg shadow-pink-200/40"
